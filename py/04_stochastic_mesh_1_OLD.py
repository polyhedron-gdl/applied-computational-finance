...
for n in range(1000, 1001, 10):
    ...
    xx           = range(0, b)
    weights_exe  = np.zeros((2, b, n))
    weights_con  = np.zeros((b-2, b, n))
    Q_exe        = np.zeros((2,n))
